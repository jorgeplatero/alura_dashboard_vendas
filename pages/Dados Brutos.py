...
dados.rename(columns = {'Local da compra': 'Local da Compra', 'Avaliação da compra': 'Avaliação da Compra', 'Tipo de pagamento': 'Tipo de Pagamento', 'Quantidade de parcelas': 'Quantidade de Parcelas'}, inplace = True)
